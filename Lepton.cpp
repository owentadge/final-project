...
// Constructors
// Parameterised
Lepton::Lepton(double energy, double px, double py, double pz, double mass_in, double charge_in, bool anti_in): 
Fermion(energy, px, py, pz, mass_in, charge_in, anti_in)
{
  if(is_anti){lepton_number = -1;}
  else lepton_number = 1;
}
Lepton::Lepton(vector<double> momentum_in, double mass_in, double charge_in, bool anti_in):
