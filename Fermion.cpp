...
// Constructors
// Parameterised
Fermion::Fermion(double energy, double px, double py, double pz, float mass_in, float charge_in, bool anti_in):
Particle(energy, px, py, pz, spin, mass_in, charge_in, anti_in){}

Fermion::Fermion(vector<double> energy_in, float mass_in, float charge_in, bool anti_in):
